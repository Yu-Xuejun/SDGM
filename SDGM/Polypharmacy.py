...
This file contains codes for example "Polypharmacy" with normal random effects:
1) GVA
2) SDGM
3) SDGM_Centered
...
"""
from examples import init_Polypharmacy
import numpy as np
import scipy
import torch as t
import time
...
plt.savefig(f"Polypharmacy_m.pdf")
...
plt.savefig(f"Polypharmacy_r.pdf")
...
plot_ELBO(VB_GVA.average_ELBOlog,VB_SDGM0.average_ELBOlog,VB_SDGM.average_ELBOlog,VB_SDGM_SAS.average_ELBOlog,VB_GVA_SAS.average_ELBOlog,
          ylim=[-1400, -850],subx=[420, 480],suby=[-925, -909],
          labels=['GVA','SDGM ','SDGM_C','SDGM+SAS','GVA+SAS'])
plt.savefig(f"Polypharmacy_ELBO.pdf")
...
"""
VB_GVA_time = 97.3254382610321
VB_SDGM0_time = 120.03933119773865
VB_SDGM_time = 123.02625012397766
VB_SDGMSAS_time = 159.11835050582886
VB_GVASAS_time = 134.33654046058655
"""
