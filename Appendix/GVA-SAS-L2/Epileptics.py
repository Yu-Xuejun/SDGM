...
VB_SDGM0.lr = 0.01
VB_SDGM0.lr_stepsize = 5
VB_SDGM0.lr_gamma = 0.5
VB_SDGM0.full_train(num_steps=20000, show = 100)
VB_SDGM0.lr = 0.01
VB_SDGM0.lr_stepsize = 2
VB_SDGM0.lr_gamma = 0.5
VB_SDGM0.full_train(num_steps=20000, show = 100)
VB_SDGM0.lr = 0.001
...
plt.legend(["GVA",'SDGM','SDGM_C',"GVA+SAS-L1",'SDGM+SAS',"GVA+SAS-L2",'MCMC'], loc = 'best',bbox_to_anchor=(1.1, 1.03))#,  bbox_to_anchor=(2.2, 0))
...
plt.savefig(f"Epilepsy_r1_SAS.pdf")
...
plot_randeff(EX.MCMC[:,ids_rand],smp_SDGM_SAS[:,ids_rand],smp_GVA_SAS[:,ids_rand],smp_GVA_SAS_EXTRA[:,ids_rand],
             mean=True,labels=['SDGM+SAS','GVA+SAS-L1','GVA+SAS-L2'])
plt.savefig(f"Epilepsy_r2_SAS.pdf")
#
...
plot_ELBO(VB_GVA.average_ELBOlog,VB_SDGM0.average_ELBOlog,VB_SDGM.average_ELBOlog,VB_SDGM_SAS.average_ELBOlog,VB_GVA_SAS.average_ELBOlog,VB_GVA_SAS_EXTRA.average_ELBOlog,
          ylim=[2500, 3300],subx=[420, 480],suby=[3248, 3260])
plt.legend(['GVA','SDGM ','SDGM_C','SDGM+SAS','GVA+SAS-L1','GVA+SAS-L2'], bbox_to_anchor=(-0.1,-0.1))#,  bbox_to_anchor=(2.2, 0))
...
print("VB_GVASAS_EXTRA_time =", VB_GVA_SAS_EXTRA_time)
